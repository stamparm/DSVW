...
NAME, VERSION, GITHUB, AUTHOR, LICENSE = "Damn Small Vulnerable Web (DSVW) < 100 LoC (Lines of Code)", "0.1c", "https://github.com/stamparm/dsvw", "Miroslav Stampar (@stamparm)", "Public domain (FREE)"
